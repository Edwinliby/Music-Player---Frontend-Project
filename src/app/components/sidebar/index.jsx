    ...
    return (
        <>
            <motion.div
                ...
                className="hidden md:flex flex-col justify-between overflow-x-visible absolute top-0 left-0 h-full z-10 text-white bg-black/50 backdrop-blur-2xl px-4 xl:px-6 py-8"
            >
                {/* Toggle Button */}
                <div
